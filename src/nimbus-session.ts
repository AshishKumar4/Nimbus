...
import type { WsHibernationConfigResult } from './nimbus-session-hib.js';
...
} from './nimbus-session-replica.js';
...
} from './nimbus-session-hib.js';
// S6: initSession (1875 LOC of cmd registrations + boot wiring) extracted.
import { initSession as _w11InitSession } from './nimbus-session-init.js';
...
} from './nimbus-session-ws.js';
// S8: Supervisor RPC + W8 cp* + legacy VFS impls extracted.
import * as _rpc from './nimbus-session-rpc.js';
// S9: HTTP fetch routing extracted (combined S9a + S9b).
import * as _routes from './nimbus-session-routes.js';
// S10: heap probe + W5 OOM-ring persistence extracted.
import * as _diag from './nimbus-session-diag.js';
...
export {
  ...
  NimbusDOStub,
} from './nimbus-session-bindings.js';
