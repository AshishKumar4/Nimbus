/**
 * nimbus-session-internal.d.ts — internal contract for the NimbusSession class.
 *
 * PUBLIC CONTRACT — NOT a runtime module.
 *
...
import type { FacetManager } from './facet-manager.js';
import type { EsbuildService } from './esbuild-service.js';
import type { ViteDevServer } from './vite-dev-server.js';
import type { CirrusReal } from './cirrus-real.js';
import type { NimbusWrangler } from './nimbus-wrangler.js';
...
import type { W12EnableResult } from './nimbus-session-replica.js';
