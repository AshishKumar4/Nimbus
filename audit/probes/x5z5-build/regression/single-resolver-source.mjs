#!/usr/bin/env bun
// X.5-Z5 regression: single-resolver invariant.
// Same probe as X.5-F/G/C/J/L/M/NPQO waves: `function resolveExports`
// declared exactly once across src/ (in _shared/exports-resolver.ts).
// Catches any accidental fork of the resolver during shim-region edits.
// Z5 edits node-shims.ts:756 (util.inherits guard), streams.ts:380
// (synthetic .prototype) and facet-manager.ts:772 (looksLikeEsm regex);
// none of those should affect resolveExports.
...
summary('z5-single-resolver-source');
