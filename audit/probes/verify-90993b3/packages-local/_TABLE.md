# Post-Phase-5 local package compat — generated 2026-05-05T20:24:01.221Z
...
| `fastify` | ⚠️ | added 46 pkgs, 1930 files | Error: Cannot find module '..' (from home/user/app/node_modules/ajv/dist/compile/jtd) |
...
| `jsdom` | ⚠️ | added 39 pkgs, 1800 files | Error: Cannot find module 'node:util/types' (from home/user/app/node_modules/undici/lib/web/fetch) |
...
| `nuxt` | ⚠️ | added 526 pkgs, 15629 files | Error: Cannot find module '../dist/defu.cjs' (from home/user/app/node_modules/defu/lib) |
...
| `redis` | ⚠️ | added 7 pkgs, 2371 files | Error: Cannot find module '.' (from home/user/app/node_modules/@redis/client/dist/lib/client) |
...
| `tailwindcss-vite` | ⚠️ | added 232 pkgs, 7505 files | Error: Cannot load module 'home/user/app/node_modules/@tailwindcss/vite/dist/index.mjs': pre-compile failed at facet startup: Cannot use import statement outside a module |
...
| `vite` | ⚠️ | added 227 pkgs, 7411 files | Error: ENOENT: no such file or directory, open 'file:///package.json' |
