...
buf = '';
w.send(JSON.stringify({ type: 'input', data: 'cat node_modules/lucide-react/package.json\r' }));
await new Promise(r => setTimeout(r, 2000));
w.send(JSON.stringify({ type: 'input', data: 'cat node_modules/lucide-react/dist/esm/lucide-react.js | head -10\r' }));
await new Promise(r => setTimeout(r, 2000));
console.log(buf.replace(/\x1b\[[^A-Za-z]*[A-Za-z]/g, '').slice(-3000));
w.close();
process.exit(0);
