// W11 regression: confirm the install-pipeline-coverage probe still
// loadable + scenario list unchanged. Mirrors w9/regression/install-pipeline-coverage.mjs.
...
await summary('w11/regression/install-pipeline-coverage');
