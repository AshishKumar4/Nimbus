#!/usr/bin/env bun
// install-performance/install-partial-detectable — manifest-first invariant.
//
...
const a = makeAsserter('install-performance/install-partial-detectable');
console.log(`install-performance/install-partial-detectable — ${BASE}`);
