#!/usr/bin/env bun
// install-performance/install-cold-still-works — basic python cold install end-to-end.
//
...
const a = makeAsserter('install-performance/install-cold-still-works');
console.log(`install-performance/install-cold-still-works — ${BASE}`);
