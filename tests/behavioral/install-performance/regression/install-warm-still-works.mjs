#!/usr/bin/env bun
// install-performance/install-warm-still-works — idempotent re-install branch
...
const a = makeAsserter('install-performance/install-warm-still-works');
console.log(`install-performance/install-warm-still-works — ${BASE}`);
