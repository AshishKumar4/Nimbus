...
console.log(`[wasi-files/rename-existing] sid=${sid} BASE=${BASE}`);
...
console.log(JSON.stringify({ probe: 'wasi-files/rename-existing', sid, base: BASE, tail, ok }, null, 2));
...
console.log(`[wasi-files/rename-existing] ${verdict} — ${pass}/${checks.length}`);
