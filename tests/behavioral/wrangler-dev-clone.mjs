...
let buildOutcome = 'silence';
{
  ...
  // an explicit timeout diagnostic. failing today = silence forever.
  ...
  try {
    ...
    // failing today: this branch fires — terminal silent for full 90s.
...
if (buildOutcome === 'success') {
  ...
  // If the build emitted a loud error, that's the passing path of this
