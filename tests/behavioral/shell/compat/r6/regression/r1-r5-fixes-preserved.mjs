#!/usr/bin/env bun
// shell/compat/r6/regression/r1-r5-fixes-preserved — R6 must not regress
...
const a = makeAsserter('shell/compat/r6/regression');
console.log(`shell/compat/r6/regression — ${process.env.BASE}`);
