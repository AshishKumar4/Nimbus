#!/usr/bin/env bun
// shell/compat/r4/new/find-predicates — shell compatibility.
//
...
const a = makeAsserter('shell/compat/r4/new/find-predicates');
console.log(`shell/compat/r4/new/find-predicates — ${process.env.BASE}`);
