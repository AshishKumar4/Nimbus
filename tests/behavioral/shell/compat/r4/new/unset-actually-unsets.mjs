#!/usr/bin/env bun
// shell/compat/r4/new/unset-actually-unsets — shell compatibility.
//
...
const a = makeAsserter('shell/compat/r4/new/unset-actually-unsets');
console.log(`shell/compat/r4/new/unset-actually-unsets — ${process.env.BASE}`);
