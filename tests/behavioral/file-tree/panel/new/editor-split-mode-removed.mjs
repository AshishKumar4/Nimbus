#!/usr/bin/env bun
// file-tree/panel/new/editor-split-mode-removed — explicitly verify
// the editor 'editor-split' mode is GONE. User: "I don't need
// 'edit + preview' at all".
//
...
console.log(`file-tree/panel/new/editor-split-mode-removed — ${process.env.BASE}`);
