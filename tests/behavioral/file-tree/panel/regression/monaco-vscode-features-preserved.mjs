#!/usr/bin/env bun
// file-tree/panel/regression/monaco-vscode-features-preserved —
// editor's VSCode-grade Monaco config must remain intact after the
// Wave-B layout changes.
//
// Mirrors a subset of editor/monaco/new/monaco-vscode-features.mjs;
...
console.log(`file-tree/panel/regression/monaco-vscode-features-preserved — ${process.env.BASE}`);
