...
// Markflow bundle. The probe goes failing iff a real user attempting
// this flow on prod would see the bug.
//
// Baseline at probe creation: documented in
//
// failing on prod 3bd8e28 → cirrus-real S2 is urgent.
// passing on prod 3bd8e28 → framework-validation P3 (CJS-interop fix)
