#!/usr/bin/env bun
// editor/monaco/new/layout-modes-toggle — HTML structural assertion
...
console.log(`editor/monaco/new/layout-modes-toggle — ${process.env.BASE}`);

const sid = await mintSession();
const r = await fetch(`${BASE}/s/${sid}/`, { redirect: 'follow' });
const html = await r.text();

// JS handlers — onclick wiring for each of the 4 modes (file-tree/panel
