 ...
 */
export function detectCloudflareWorkersProject(vfs, root) {
    ...
    try {
        ...
        if (vfs.exists(pkgPath)) {
            ...
            if (pkg && typeof pkg === 'object') {
                if (pkg.devDependencies && typeof pkg.devDependencies === 'object' && 'wrangler' in pkg.devDependencies)
                    return true;
                if (pkg.dependencies && typeof pkg.dependencies === 'object' && 'wrangler' in pkg.dependencies)
                    return true;
            }
        }
    }
