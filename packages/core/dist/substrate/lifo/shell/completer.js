...
function findCurrentWord(beforeCursor) {
...
function determineContext(beforeCursor, word) {
    // After $ -> variable
    if (word.startsWith('$')) {
        return 'variable';
    }
...
function getLastCommandName(prefix) {
...
function completeCommand(word, ctx) {
...
function completeVariable(prefix, ctx) {
