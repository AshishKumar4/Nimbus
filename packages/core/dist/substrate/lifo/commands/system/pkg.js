...
export function createPkgCommand(registry) {
...
function registerPkgCommand(registry, _ctx, name) {
    const scriptPath = `/usr/share/pkg/node_modules/${name}/index.js`;
    registry.registerLazy(name, () => import('./node.js').then((mod) => ({
        default: (async (cmdCtx) => (await mod.default({
            ...cmdCtx,
