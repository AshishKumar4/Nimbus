const PAGES = {
    ...
    df: { synopsis: 'df [-ahT] [FILE]...', description: 'Report disk space of each mount, or of the mount each FILE is on. -a include mounts without usage, -h human-readable, -T show type.' },
    mount: { synopsis: 'mount [-l] [-t TYPE]', description: 'List mounted filesystems. Mounts come from the host.' },
