...
function ensureVisible(s) {
    ...
    if (s.cursorRow >= s.scrollRow + contentH)
        s.scrollRow = s.cursorRow - contentH + 1;
    if (s.cursorCol < s.scrollCol)
        s.scrollCol = s.cursorCol;
    if (s.cursorCol >= s.scrollCol + s.cols)
