...
export class RoutingTable {
    ...
    addRoute(route) {
        ...
        this.routes = this.routes.filter((r) => !(r.destination === route.destination &&
     ...
     */
    removeRoute(destination, iface, namespace) {
