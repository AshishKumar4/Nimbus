 ...
 */
export function parseUnitFile(content) {
    const unit = {
        Unit: {},
        Service: {},
        Install: {},
            ...
            case 'Service':
                switch (key) {
                    ...
                    case 'ExecStop':
                        ...
                        break;
                    case 'Type':
                        if (value === 'simple' || value === 'oneshot')
                            unit.Service.Type = value;
                        break;
                    case 'Restart':
                        if (value === 'no' || value === 'always' || value === 'on-failure')
