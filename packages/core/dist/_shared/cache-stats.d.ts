 ...
 */
export declare function recordHit(tier: CacheTier, kind: CacheKind, bytes: number): void;
/**
 ...
 */
export declare function recordMiss(tier: CacheTier, kind: CacheKind): void;
/**
 ...
 */
export declare function snapshot(): CacheStatsSnapshot;
/**
