 ...
 */
export function typescriptFallbackCandidates(base) {
    if (NON_MAPPING_EXTENSION.test(base))
        return [];
    if (base.endsWith('.mjs'))
        return [base.slice(0, -4) + '.mts'];
    if (base.endsWith('.js')) {
...
export const TYPESCRIPT_INDEX_CANDIDATES = ['/index.ts', '/index.tsx'];
/**
 ...
 */
export function getTypescriptSpecifiersJS() {
    return `
