...
const RuntimeTextDecoder = TextDecoder;
const RuntimeTextEncoder = TextEncoder;

export {
	RuntimeTextDecoder as TextDecoder,
	RuntimeTextEncoder as TextEncoder,
};
...
export default {
	...
	TextDecoder: RuntimeTextDecoder,
