 ...
 */
async function addRoute(ctx: { stdout: { write: (s: string) => void }; stderr: { write: (s: string) => void } },
args: string[],
networkStack: NetworkStack): Promise<number> { if (args.length < 2) {
 ...
 */
async function deleteRoute(ctx: { stdout: { write: (s: string) => void }; stderr: { write: (s: string) => void } },
args: string[],
networkStack: NetworkStack): Promise<number> { if (args.length < 2) {
