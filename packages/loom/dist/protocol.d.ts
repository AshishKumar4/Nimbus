...
export declare const STATE_FRAME_TYPE = "cf_agent_state";
/** Server → client: a client state update was refused. */
export declare const STATE_ERROR_FRAME_TYPE = "cf_agent_state_error";
/** Callable RPC, both directions. */
export declare const RPC_FRAME_TYPE = "rpc";
...
export declare function isStateFrame(value: unknown): value is StateFrame;
/** Same guard the Agents server uses: all four fields, `args` an array. */
export declare function isRpcRequestFrame(value: unknown): value is RpcRequestFrame;
/** The client-side guard for response frames. */
export declare function isRpcResponseFrame(value: unknown): value is RpcResponseFrame;
