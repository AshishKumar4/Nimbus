...
import { FACET_PROVIDED_PACKAGES, FS_READ_BATCH_PATH_LIMIT, FS_READ_BATCH_REQUEST_BYTES, NIMBUS_AI_GATEWAY_PORT, NODE_VERSION, NODE_VERSIONS, RESIDENT_FILL_MAX_BYTES, VFS_CAPACITY, } from '@nimbus-sh/core/constants.js';
...
const __fsMod = (() => {
  ...
  // still holding.
  const _FILL_MAX_BYTES = ${RESIDENT_FILL_MAX_BYTES};
