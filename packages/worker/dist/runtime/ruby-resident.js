 ...
 */
import { z } from 'zod';
import { buildRubyPreamble, normalizeRubyFacetResult, } from '@nimbus-sh/core/runtime/ruby-runner.js';
 ...
 */
export function rubyResidentStart(facetMgr) {
    return async function startResidentRuby(args) {
