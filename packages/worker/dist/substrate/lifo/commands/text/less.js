    ...
    switch (key.type) {
        case 'char':
            switch (key.char) {
                case 'q': return true;
                case 'j':
                    s.scrollRow = Math.min(s.scrollRow + 1, maxScroll(s));
                    break;
                case 'k':
                    s.scrollRow = Math.max(s.scrollRow - 1, 0);
                    break;
                case 'f':
                case ' ':
                    s.scrollRow = Math.min(s.scrollRow + ch, maxScroll(s));
                    break;
                case 'b':
                    s.scrollRow = Math.max(s.scrollRow - ch, 0);
                    break;
                case 'd':
                    s.scrollRow = Math.min(s.scrollRow + Math.floor(ch / 2), maxScroll(s));
                    break;
                case 'u':
                    s.scrollRow = Math.max(s.scrollRow - Math.floor(ch / 2), 0);
                    break;
                case 'g':
                    s.scrollRow = 0;
                    break;
                case 'G':
                    s.scrollRow = maxScroll(s);
                    break;
                case '/':
                    s.mode = 'search';
                    s.searchBuf = '';
                ...
                case 'N':
                    ...
                    break;
                case 'h':
                    s.scrollCol = Math.max(s.scrollCol - 1, 0);
                    break;
                case 'l':
                    s.scrollCol++;
                    break;
...
function handleSearchKey(s, key) {
    switch (key.type) {
        case 'enter':
