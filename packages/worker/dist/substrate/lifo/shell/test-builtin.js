...
function evaluateTestExpression(args, vfs, stderr, context, mode) {
    // `[` requires closing `]`
...
function parseExpr(args, pos, vfs, context, mode) {
    return parseOr(args, pos, vfs, context, mode);
}
function parseOr(args, pos, vfs, context, mode) {
...
function parseAnd(args, pos, vfs, context, mode) {
...
function parsePrimary(args, pos, vfs, context, mode) {
    if (pos >= args.length) {
