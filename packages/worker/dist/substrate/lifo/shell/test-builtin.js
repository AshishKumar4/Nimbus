 ...
 */
export function evaluateTest(args, vfs, stderr, context) {
    // `[` requires closing `]`
...
function parseExpr(args, pos, vfs, context) {
    return parseOr(args, pos, vfs, context);
}
function parseOr(args, pos, vfs, context) {
...
function parseAnd(args, pos, vfs, context) {
...
function parsePrimary(args, pos, vfs, context) {
    if (pos >= args.length) {
