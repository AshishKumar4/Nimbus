...
import { MemoryPersistenceBackend } from './persistence/backends.js';
...
`;
const DEFAULT_PROFILE = `export PATH=${DEFAULT_PATH}
export EDITOR=nano
`;
...
export class Kernel {
    ...
    constructor(backend) {
        ...
        this.persistence = new PersistenceManager(backend ?? new MemoryPersistenceBackend());
    }
    async boot(options) {
