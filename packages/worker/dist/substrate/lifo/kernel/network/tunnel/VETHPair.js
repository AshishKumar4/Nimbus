...
export class VETHPair {
    ...
    waiters0 = [];
    waiters1 = [];
    constructor(id, name0, name1, networkStack, namespace0 = 'default', namespace1 = 'default') {
        this.id = id;
     ...
     */
    async moveToNamespace(which, namespace) {
     ...
     */
    getInterface(name) {
        if (this.veth0.name === name)
            return this.veth0;
        if (this.veth1.name === name)
            return this.veth1;
        return null;
    }
    /**
