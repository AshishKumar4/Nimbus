...
export type { PoolOptions, MapOptions, PmapOptions, SubmitOptions, StreamOptions, StreamResult, ScatterOptions, ResilienceOptions, OnErrorStrategy, } from './pool.js';
...
export type { WorkerLoader, WorkerCode, WorkerStub, EntrypointStub, EntrypointOptions, GetCodeCallback, ServiceStub, ModuleContent, } from './types.js';
import { WorkerPool } from './pool.js';
import type { PoolOptions } from './pool.js';
import type { WorkerLoader } from './types.js';
export declare const Parallel: {
    readonly pool: (loader: WorkerLoader, opts?: PoolOptions) => WorkerPool;
};
