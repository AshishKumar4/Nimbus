 ...
 */
export declare function runOneShotWorker<T>(env: ResidentFacetEnv, supervisor: ResidentSupervisorProps, params: OneShotParams, consume: (response: Response) => Promise<T>): Promise<T>;
export {};
