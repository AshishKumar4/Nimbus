 ...
 * these rows.
 */
export declare const PORT_CAPABILITY_KEY_PREFIX = "nimbus_preview_capability:";
/**
 ...
 */
export declare const DURABLE_SLOT_KEY_PREFIX = "durable-slot:";
/** Atomic resident identity claim: owner → winning pid, released at process termination. */
export declare const RESIDENT_OWNER_KEY_PREFIX = "resident-owner:";
/** Owner → retained durable image digests, including images of stopped processes. */
export declare const DURABLE_IMAGES_KEY_PREFIX = "durable-images:";
/**
 ...
 */
export declare const SHELL_STATE_KEY_PREFIX = "nimbus_programmatic_shell:";
