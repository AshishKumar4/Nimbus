...
export function policyShouldSkipPackage(policy, name, frameworkAware) {
    if (frameworkAware && policy.frameworkRequiredPackages.includes(name))
        return false;
    if (policy.skipPackages.includes(name))
        return true;
