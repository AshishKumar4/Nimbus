...
async function emitGenerated(version, entryPath, sidecars, buildId, treeSitterWasms) {
  const header = `/**
...
async function main() {
  ...
  if (!(await exists(DIST_DIR))) {
    ...
    await emitGenerated(version, null, [], '', null);
    return;
  }
  ...
  await emitGenerated(version, entryPath, sidecars, buildId, resolveTreeSitterWasms(sidecars));
