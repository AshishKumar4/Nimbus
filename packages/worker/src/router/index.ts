 ...
 */
const publicTenantCache = new Map<string, PublicResolution>();

/** What the directory answers for a public capability: where it lives and, when named, what it is called. */
