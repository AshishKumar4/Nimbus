 ...
 */
function pythonReplStepFacetFn(args: Record<string, unknown>): Promise<PythonReplFacetResult> {
  const g = globalThis as unknown as Record<string, (a: unknown) => Promise<PythonReplFacetResult>>;
