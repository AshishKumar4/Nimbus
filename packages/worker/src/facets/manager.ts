...
export class FacetManager {
  ...
  private async _buildProcessBundle(
    ...
    const vfsState = await buildPrefetchBundle(
      ...
      this.residencyProfiles.get(key), pacer, this.hooks.transformLargeEsm,
    );
