 ...
 */
export async function restorePersistedDevServer(self: RoutesHost, onlyPort?: number): Promise<void> {
 ...
 */
export function acceptCirrusHmrWs(self: RoutesHost, request: Request): Response {
