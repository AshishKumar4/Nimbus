...
export async function setupCloudflare(args) {
    ...
    for (const bucket of buckets) {
        ...
        if (code !== 0) {
            process.stderr.write('nimbus setup cloudflare: R2 bucket setup failed. If Wrangler printed code 10042, enable R2 in the Cloudflare Dashboard and rerun this command.\n');
            return code;
        }
    }
