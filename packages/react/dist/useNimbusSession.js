 ...
 */
export function useNimbusSession(opts) {
    ...
    useEffect(() => {
        ...
        function onMessage(ev) {
            ...
            if (data.type === 'nimbus:ready')
                ...
                setError(new NimbusTerminalError(typeof data.message === 'string' ? data.message : 'Unknown', (typeof data.code === 'string' ? data.code : 'E_UNKNOWN')));
            }
        }
